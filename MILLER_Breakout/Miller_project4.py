...
class Breakout():
    ...
    def main(self):
        ...
        bat_speed = 40
        score = 0 
        bgcolour = (145,204,255)      
        size = width, height = 640, 480

        pygame.init()            
        screen = pygame.display.set_mode(size)
        pygame.display.set_caption("A Margarinally Funny Game")
        #screen = pygame.display.set_mode(size, pygame.FULLSCREEN)

        bat = pygame.image.load("knife.png").convert()
        batrect = bat.get_rect()

        ball = pygame.image.load("butter.png").convert()
        ball.set_colorkey((255, 255, 255))
        ballrect = ball.get_rect()
       
        pong = pygame.mixer.Sound('butter.mp3')
        pong.set_volume(10)        
        ...
        while 1:
            ...
            if ballrect.top > height:
                ...
                if lives == 0:                    
                    msg = pygame.font.Font(None,70).render("Butter Luck Next Time", True, (102,0,0), bgcolour)
            ...
            screen.fill(bgcolour)
            scoretext = pygame.font.Font(None,40).render(str(score), True, (145,0,0), bgcolour)
...
class Wall():
    ...
    def __init__(self):
        self.brick = pygame.image.load("bread.png").convert()
